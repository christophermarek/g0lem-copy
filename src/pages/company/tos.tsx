...
const TOS: NextPage = () => {
  return (
    <div>
      ...
      <p>Welcome to g0lem!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of g0lems Website,
        located at g0lem.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use g0lem if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      ...
      <p>
        ...
        this website and compliant to the Companys terms and conditions. The Company, Ourselves, We,
        ...
        the express purpose of meeting the Clients needs in respect of provision of the Companys
      ...
      <p>
        We employ the use of cookies. By accessing g0lem, you agreed to use cookies in agreement
        with the g0lems Privacy Policy.{' '}
      </p>

      <p>
        Most interactive websites use cookies to let us retrieve the users details for each visit.
      ...
      <p>
        Unless otherwise stated, g0lem and/or its licensors own the intellectual property rights for
        all material on g0lem. All intellectual property rights are reserved. You may access this
        from g0lem for your own personal use subjected to restrictions set in these terms and
        conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from g0lem</li>
        <li>Sell, rent or sub-license material from g0lem</li>
        <li>Reproduce, duplicate or copy material from g0lem</li>
        <li>Redistribute content from g0lem</li>
      </ul>
      ...
      <p>
        ...
        information in certain areas of the website. g0lem does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect the views and
        opinions of g0lem,its agents and/or affiliates. Comments reflect the views and opinions of
        the person who post their views and opinions. To the extent permitted by applicable laws,
        g0lem shall not be liable for the Comments or for any liability, damages or expenses caused
        and/or suffered as a result of any use of and/or posting of and/or appearance of the
        Comments on this website.
      </p>

      <p>
        g0lem reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant g0lem a non-exclusive license to use, reproduce, edit and authorize others
      ...
      <p>
        ...
        and (c) fits within the context of the linking partys site.
      </p>
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of g0lem; and (d) the link is in the
      ...
      <p>
        ...
        party and its products or services; and (c) fits within the context of the linking partys
        site.
      </p>

      <p>
        If you are one of the organizations listed in paragraph 2 above and are interested in
        linking to our website, you must inform us by sending an e-mail to g0lem. Please include
      ...
      <ul>
        ...
        <li>
          ...
          context and format of content on the linking partys site.
        </li>
      </ul>

      <p>
        No use of g0lems logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
      ...
      <p>
        ...
        reserve the right to amen these terms and conditions and its linking policy at any time. By
