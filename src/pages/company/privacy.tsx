...
const Privacy: NextPage = () => {
  return (
    <>
      ...
      <p>
        g0lem built the g0lem app as an Open Source app. This SERVICE is provided by g0lem at no
      ...
      <p>
        ...
        which are accessible at g0lem unless otherwise defined in this Privacy Policy.
      </p>{' '}
      <p>
      ...
      <div>
        <p>
          We do not knowingly collect personally identifiable information from children. We
          encourage all children to never submit any personally identifiable information through the
          Application and/or Services. We encourage parents and legal guardians to monitor their
          childrens Internet usage and to help enforce this Policy by instructing their children
          never to provide personally identifiable information through the Application and/or
          Services without their permission. If you have reason to believe that a child has provided
          personally identifiable information to us through the Application and/or Services, please
          contact us. You must also be at least 16 years of age to consent to the processing of your
          personally identifiable information in your country (in some countries we may allow your
      ...
      <p>This policy is effective as of 2023-02-08</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do not hesitate to
        contact us at appg0lem@proton.m.
      </p>
    </>
  );
};
